...
def Inference(FLAGS):
    ...
    snapshot_path = "./model/prostate_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
    test_save_path = "./model/prostate_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
